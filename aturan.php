    ...
    <div class="card-body">
        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
                ...
                <?php
                $no = 1;
                $sql = "SELECT basis_aturan.id_aturan, basis_aturan.id_penyakit, penyakit.nama_penyakit, penyakit.keterangan FROM basis_aturan INNER JOIN penyakit
                ...
                ?>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a class="btn btn-primary" href="?page=aturan&action=update&id=<?php echo $row['id_aturan']; ?>">
