...
penyakit.keterangan FROM basis_aturan INNER JOIN penyakit ON basis_aturan.id_penyakit=penyakit.id_penyakit WHERE basis_aturan.id_aturan='$id_aturan'";
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT detail_basis_aturan.id_aturan, detail_basis_aturan.id_gejala, gejala.nama_gejala 
                                        FROM detail_basis_aturan INNER JOIN gejala ON detail_basis_aturan.id_gejala=gejala.id_gejala WHERE detail_basis_aturan.id_aturan='$id_aturan'";
                                $result = $conn->query($sql);
